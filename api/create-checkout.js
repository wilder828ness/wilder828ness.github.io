...
module.exports = async (req, res) => {
    ...
    try {
        ...
        // Order revenue (product subtotal, excl. shipping) → passed to the success
        // URL so Google Ads conversion tracking records the real sale value.
        const orderValue = (cartItems.reduce((s, i) => s + Math.round((i.price || 0) * 100) * (i.quantity || 1), 0) / 100).toFixed(2);
